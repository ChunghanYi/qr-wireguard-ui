...
DEFUN (bridge_disable,
        bridge_disable_cmd,
        "bridge disable",
        "Specify whether bridge mode is enabled or disabled\n"
        "Disable bridge mode\n")
{
	char szInfo[64];
	sprintf(szInfo, "bridge disable");
...
DEFUN (no_bridge_disable,
        no_bridge_disable_cmd,
        "no bridge disable",
		NO_STR
        "Specify whether bridge mode is enabled or disabled\n"
        "Disable bridge mode\n")
...
int cmd_bridge_init()
{
	...
	cmd_install_element (CONFIG_NODE, &bridge_disable_cmd);
	cmd_install_element (CONFIG_NODE, &no_bridge_disable_cmd);
